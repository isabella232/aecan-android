...
public class OneSelectedModalAdapter extends RecyclerView.Adapter<OneSelectedModalAdapter.ListViewHolder> {
    private ArrayList<Item> items;
    private int resource;
    private Integer positionSelected = -1;

    public OneSelectedModalAdapter(ArrayList<Item> items, int resource) {
        this.items = items;
